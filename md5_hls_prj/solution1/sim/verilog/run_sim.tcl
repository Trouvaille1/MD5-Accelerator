...
if {[file isfile md5_wrap.autotvin.dat]} {
	file delete -force md5_wrap.autotvin.dat
}

if {[file isfile md5_wrap.autotvout.dat]} {
	file delete -force md5_wrap.autotvout.dat
}
