...
entity md5_wrap_flow_control_loop_pipe_sequential_init is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity md5_wrap_flow_control_loop_pipe_sequential_init;

architecture behav of md5_wrap_flow_control_loop_pipe_sequential_init is
