...
signed int apatb_md5_wrap_sw(signed int ,  char *,  char *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = call i32 @apatb_md5_wrap_sw(i32 %%8, i8* %%1, i8* %%9) nounwind, !dbg !6 for 0x%I64xth hint within @md5_test  --> \n", ++aesl_llvm_cbe_22_count);
  apatb_md5_wrap_sw(llvm_cbe_tmp__8, ( char *)llvm_cbe_tmp__1, ( char *)llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = call i32 @apatb_md5_wrap_sw(i32 %%14, i8* %%3, i8* %%9) nounwind, !dbg !6 for 0x%I64xth hint within @md5_test  --> \n", ++aesl_llvm_cbe_27_count);
  apatb_md5_wrap_sw(llvm_cbe_tmp__13, ( char *)llvm_cbe_tmp__3, ( char *)llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = call i32 @apatb_md5_wrap_sw(i32 %%20, i8* %%5, i8* %%9) nounwind, !dbg !6 for 0x%I64xth hint within @md5_test  --> \n", ++aesl_llvm_cbe_33_count);
  apatb_md5_wrap_sw(llvm_cbe_tmp__17, ( char *)llvm_cbe_tmp__5, ( char *)llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i32 @apatb_md5_wrap_sw(i32 %%26, i8* %%5, i8* %%9) nounwind, !dbg !6 for 0x%I64xth hint within @md5_test  --> \n", ++aesl_llvm_cbe_40_count);
  apatb_md5_wrap_sw(llvm_cbe_tmp__21, ( char *)llvm_cbe_tmp__5, ( char *)llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE) {
