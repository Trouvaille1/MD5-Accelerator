...
`define AUTOTB_DUT      md5_wrap
`define AUTOTB_DUT_INST AESL_inst_md5_wrap
`define AUTOTB_TOP      apatb_md5_wrap_top
`define AUTOTB_LAT_RESULT_FILE "md5_wrap.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "md5_wrap.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_md5_wrap_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_text_length 1
`define AESL_DEPTH_text_input 1
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.md5_wrap.autotvin_gmem.dat"
`define AUTOTB_TVIN_text_length_out_wrapc  "../tv/rtldatafile/rtl.md5_wrap.autotvin_text_length.dat"
`define AUTOTB_TVIN_text_input_out_wrapc  "../tv/rtldatafile/rtl.md5_wrap.autotvin_text_input.dat"
`define AUTOTB_TVIN_result_out_wrapc  "../tv/rtldatafile/rtl.md5_wrap.autotvin_result.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.md5_wrap.autotvout_gmem.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.md5_wrap.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.md5_wrap.autotvout_gmem.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.md5_wrap.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_gmem = 1040;
parameter LENGTH_result = 1;
parameter LENGTH_text_input = 1;
parameter LENGTH_text_length = 1;
...
assign AESL_continue = tb_continue;
  assign AESL_slave_write_start_in = slave_start_status  & CTRL_write_data_finish & control_write_data_finish;
...
reg end_text_length;
reg [31:0] size_text_length;
reg [31:0] size_text_length_backup;
reg end_text_input;
reg [31:0] size_text_input;
reg [31:0] size_text_input_backup;
reg end_result;
