...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Work/Xilinx/Vitis_HLS/2023.1/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);D:/Work/Xilinx/Vitis_HLS/2023.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Work/Xilinx/Vitis_HLS/2023.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Work/Xilinx/Vitis_HLS/2023.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "md5_wrap.autotvin.dat"
	set constFileTvOut       "md5_wrap.autotvout.dat"
	set constFileHdlTvIn     "md5_wrap.autohdltvin.dat"
	set constFileHdlTvOut    "md5_wrap.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
