...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.md5_wrap.autotvin_gmem.dat"
         "c.md5_wrap.autotvin_text_length.dat"
         "c.md5_wrap.autotvin_text_input.dat"
         "c.md5_wrap.autotvin_result.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.md5_wrap.autotvout_gmem.dat"
         "rtl.md5_wrap.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
