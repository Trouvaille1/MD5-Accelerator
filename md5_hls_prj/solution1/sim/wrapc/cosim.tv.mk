...
$(ObjDir)/md5_test.c_pre.c.tb.o : md5_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) md5_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/md5.c_pre.c.tb.o : md5.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) md5.c_pre.c.tb.c" $(AVE_DIR_DLOG)
