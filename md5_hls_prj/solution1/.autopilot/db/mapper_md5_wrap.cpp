...
using hls::sim::Byte;
extern "C" int md5_wrap(Byte<1>*, int, int, int);
extern "C" int apatb_md5_wrap_hw(int __xlx_apatb_param_text_length, volatile void * __xlx_apatb_param_text_input, volatile void * __xlx_apatb_param_result) {
using hls::sim::createStream;
  // Collect __xlx_text_input_result__tmp_vec
std::vector<Byte<1>> __xlx_text_input_result__tmp_vec;
for (size_t i = 0; i < 1024; ++i){
__xlx_text_input_result__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_text_input)[i]);
}
  int __xlx_size_param_text_input = 1024;
  int __xlx_offset_param_text_input = 0;
  int __xlx_offset_byte_param_text_input = 0*1;
for (size_t i = 0; i < 16; ++i){
__xlx_text_input_result__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_result)[i]);
}
  int __xlx_size_param_result = 16;
  int __xlx_offset_param_result = 1024;
  int __xlx_offset_byte_param_result = 1024*1;
  // DUT call
  int ap_return = md5_wrap(__xlx_text_input_result__tmp_vec.data(), __xlx_apatb_param_text_length, __xlx_offset_byte_param_text_input, __xlx_offset_byte_param_result);
// print __xlx_apatb_param_text_input
for (size_t i = 0; i < __xlx_size_param_text_input; ++i) {
((Byte<1>*)__xlx_apatb_param_text_input)[i] = __xlx_text_input_result__tmp_vec[__xlx_offset_param_text_input+i];
}
// print __xlx_apatb_param_result
for (size_t i = 0; i < __xlx_size_param_result; ++i) {
((Byte<1>*)__xlx_apatb_param_result)[i] = __xlx_text_input_result__tmp_vec[__xlx_offset_param_result+i];
}
return ap_return;
}
