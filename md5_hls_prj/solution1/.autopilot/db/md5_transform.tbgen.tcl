...
set portList { 
	...
	{ data_address0 sc_out sc_lv 6 signal 4 } 
	{ data_ce0 sc_out sc_logic 1 signal 4 } 
	{ data_q0 sc_in sc_lv 8 signal 4 } 
	{ data_address1 sc_out sc_lv 6 signal 4 } 
	{ data_ce1 sc_out sc_logic 1 signal 4 } 
	{ data_q1 sc_in sc_lv 8 signal 4 } 
...
set Spec2ImplPortList { 
	...
	data { ap_memory {  { data_address0 mem_address 1 6 }  { data_ce0 mem_ce 1 1 }  { data_q0 mem_dout 0 8 }  { data_address1 MemPortADDR2 1 6 }  { data_ce1 MemPortCE2 1 1 }  { data_q1 MemPortDOUT2 0 8 } } }
}
